...
const Hero = () => {
  return (
    <div className="w-full bg-white py-8 md:py-24 sm:px-6 flex flex-col-reverse md:flex-row justify-between items-center">
      <div className="flex flex-col justify-start sm:gap-4 sm:w-4/5 w-[95%] md:w-[70%] ">
