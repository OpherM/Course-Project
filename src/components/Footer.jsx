...
const Footer = () => {
    return (
      <div className="w-full px-6 flex flex-col md:flex-row bg-white py-24">
        <div className="">
          <h1 className="md:text-4xl text-4xl font-semibold text-[#20B486]">
            Practice
          </h1>
          ...
          <div className="flex gap-3 py-6">
            ...
            <div className="bg-[#E9F8F3] p-3 rounded-xl cursor-pointer">
              <BsDribbble style={{ color: "#4DC39E" }} size={25} />
            </div>
            <div className="p-3 rounded-xl bg-[#E9F8F3] cursor-pointer">
              <TfiLinkedin style={{ color: "#4DC39E" }} size={25} />
            </div>
            <div className="bg-[#E9F8F3] p-3 rounded-xl cursor-pointer">
              <BsInstagram style={{ color: "#4DC39E" }} size={25} />
            </div>
            <div className="bg-[#E9F8F3] p-3 rounded-xl cursor-pointer">
              <BsBehance style={{ color: "#4DC39E" }} size={25} />
            </div>
          </div>
        </div>
