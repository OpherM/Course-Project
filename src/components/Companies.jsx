...
const Companies = () => {
  return (
    <div className='w-full bg-white m-auto'>
        <div className='md:max-w-[1390px] max-w-[600px] leading-[50px] flex flex-col max-w-[943px] m-auto justify-content-center items-center'>
            <h1 className='text-[#536E96] font-bold text-[24px]'>Trusted by over 25,000 teams around the world.</h1>
            <p className='text-[#536E96]'>Leading companies use the same courses to help employees keep their skills fresh.</p>
